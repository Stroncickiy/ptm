        ...
        <div class="content-lg container">
            ...
            <div class="row margin-b-50">
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="/resources/img/970x647/01.jpg" alt="Our Exceptional Solutions Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="/resources/img/970x647/02.jpg" alt="Our Exceptional Solutions Image">
                        </div>
                    </div>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="/resources/img/970x647/03.jpg" alt="Our Exceptional Solutions Image">
                        </div>
                    </div>
